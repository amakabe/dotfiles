...
syn include @xmlDTD /usr/share/vim/vim72/syntax/dtd.vim
...
syn include @ascode syntax/actionscript.vim
syn region mxmlCDataActionScript3 matchgroup=ascode start="<!\[CDATA\[" keepend end="\]\]>" contains=@ascode
